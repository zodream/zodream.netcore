...
namespace ZoDream.Business.Base_SysManage
{
    public class RapidDevelopmentBusiness : BaseBusiness<Base_DatabaseLink>
    {
        ...
        {
            string entityPath = _contentRootPath.Replace("ZoDream.Web", "ZoDream.Entity");
            string filePath = Path.Combine(entityPath, areaName, $"{tableName}.cs");
            string nameSpace = $@"ZoDream.Entity.{areaName}";
...
namespace ZoDream.Business.{areaName}
{{
    ...
    {{
        ...
        #region 数据模型
            ...
            string businessPath = _contentRootPath.Replace("ZoDream.Web", "ZoDream.Business");
        ...
        private void BuildController(string areaName, string entityName)
        {
            ...
            string code =
$@"using ZoDream.Business.{areaName};
using ZoDream.Entity.{areaName};
using ZoDream.Util;
